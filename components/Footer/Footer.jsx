...
const Footer = () => {
  return (
    <div>
      <div className="bg-amber-500 w-full h-[200px] mt-28 flex justify-between px-5 xl:px-20 2xl:px-20 lg:px-20 md:px-20 items-center">
        <div>
          <h1 className="text-4xl font-sansita font-bold">LOGO</h1>
        </div>
        <div className="">
            <ul className="gap-2 font-semibold text-md">
                <li>Home</li>
                <li>Yakında</li>
                <li>Yakında</li>
                <li>Yakında</li>
